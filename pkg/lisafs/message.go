...
func (s *SizedString) CheckedUnmarshal(src []byte) ([]byte, bool) {
	var (
		strLen primitive.Uint32
		ok     bool
	)
	src, ok = strLen.CheckedUnmarshal(src)
	if !ok {
		return nil, false
	}
	if len(src) < int(strLen) {
		return nil, false
	}
...
func (s *StringArray) CheckedUnmarshal(src []byte) ([]byte, bool) {
	var (
		arrLen primitive.Uint32
		ok     bool
	)
	src, ok = arrLen.CheckedUnmarshal(src)
	if !ok {
		return nil, false
	}
	...
	for i := primitive.Uint32(0); i < arrLen; i++ {
		...
		src, ok = sstr.CheckedUnmarshal(src)
		if !ok {
			return nil, false
		}
		(*s)[i] = string(sstr)
...
func (m *MountResp) CheckedUnmarshal(src []byte) ([]byte, bool) {
	...
	if len(m.SupportedMs)*(*MID)(nil).SizeBytes() > len(src) {
		return nil, false
	}
	return UnmarshalUnsafeMIDSlice(m.SupportedMs, src), true
}
...
func (w *WalkReq) CheckedUnmarshal(src []byte) ([]byte, bool) {
	...
	return w.Path.CheckedUnmarshal(src)
}
...
func (w *WalkResp) CheckedUnmarshal(src []byte) ([]byte, bool) {
	...
	if len(w.Inodes)*(*Inode)(nil).SizeBytes() > len(src) {
		return nil, false
	}
	return UnmarshalUnsafeInodeSlice(w.Inodes, src), true
}
...
func (w *WalkStatResp) CheckedUnmarshal(src []byte) ([]byte, bool) {
	...
	if len(w.Stats)*linux.SizeOfStatx > len(src) {
		return nil, false
	}
	return linux.UnmarshalUnsafeStatxSlice(w.Stats, src), true
}
...
func (o *OpenCreateAtReq) CheckedUnmarshal(src []byte) ([]byte, bool) {
	...
	src = o.Flags.UnmarshalUnsafe(src)
	return o.Name.CheckedUnmarshal(src)
}
...
func (f *FdArray) CheckedUnmarshal(src []byte) ([]byte, bool) {
	*f = (*f)[:0]
	...
	if len(*f)*(*FDID)(nil).SizeBytes() > len(src) {
		return nil, false
	}
	return UnmarshalUnsafeFDIDSlice(*f, src), true
}
...
func (r *PReadResp) CheckedUnmarshal(src []byte) ([]byte, bool) {
	var ok bool
	src, ok = r.NumBytes.CheckedUnmarshal(src)
	if !ok || int(r.NumBytes) > len(src) || int(r.NumBytes) > len(r.Buf) {
		return nil, false
	}

	// We expect the client to have already allocated r.Buf. r.Buf probably
	// (optimally) points to usermem. Directly copy into that.
	return src[copy(r.Buf[:r.NumBytes], src[:r.NumBytes]):], true
}
...
func (w *PWriteReq) CheckedUnmarshal(src []byte) ([]byte, bool) {
	...
	if int(w.NumBytes) > len(src) {
		return nil, false
	}
	w.Buf = src[:w.NumBytes]
	return src[w.NumBytes:], true
}
...
func (m *MkdirAtReq) CheckedUnmarshal(src []byte) ([]byte, bool) {
	...
	return m.Name.CheckedUnmarshal(src)
}
...
func (m *MknodAtReq) CheckedUnmarshal(src []byte) ([]byte, bool) {
	...
	src = m.Major.UnmarshalUnsafe(src)
	return m.Name.CheckedUnmarshal(src)
}
...
func (s *SymlinkAtReq) CheckedUnmarshal(src []byte) ([]byte, bool) {
	...
	var ok bool
	src, ok = s.Name.CheckedUnmarshal(src)
	if !ok {
		return nil, false
	}
	return s.Target.CheckedUnmarshal(src)
}
...
func (l *LinkAtReq) CheckedUnmarshal(src []byte) ([]byte, bool) {
	...
	return l.Name.CheckedUnmarshal(src)
}
...
func (u *UnlinkAtReq) CheckedUnmarshal(src []byte) ([]byte, bool) {
	...
	src = u.Flags.UnmarshalUnsafe(src)
	return u.Name.CheckedUnmarshal(src)
}
...
func (r *RenameAtReq) CheckedUnmarshal(src []byte) ([]byte, bool) {
	...
	return r.NewName.CheckedUnmarshal(src)
}
...
func (d *Dirent64) CheckedUnmarshal(src []byte) ([]byte, bool) {
	...
	return d.Name.CheckedUnmarshal(src)
}
...
func (g *Getdents64Resp) CheckedUnmarshal(src []byte) ([]byte, bool) {
	...
	var ok bool
	for i := range g.Dirents {
		src, ok = g.Dirents[i].CheckedUnmarshal(src)
		if !ok {
			return nil, false
		}
	}
...
func (g *FGetXattrReq) CheckedUnmarshal(src []byte) ([]byte, bool) {
	...
	return g.Name.CheckedUnmarshal(src)
}
...
func (s *FSetXattrReq) CheckedUnmarshal(src []byte) ([]byte, bool) {
	...
	return s.Value.CheckedUnmarshal(src)
}
...
func (r *FRemoveXattrReq) CheckedUnmarshal(src []byte) ([]byte, bool) {
	...
	return r.Name.CheckedUnmarshal(src)
}
